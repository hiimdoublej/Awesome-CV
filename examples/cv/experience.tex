  ...
  \cventry
    ...
    {Aug. 2023 - Nov. 2025} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Introduce automation in necessary areas, improve application deploy velocity to over 10+ deploys per day. }
        ...
        \item {Increased stability of low latency live streaming with WebRTC. }
      \end{cvitems}
    }
