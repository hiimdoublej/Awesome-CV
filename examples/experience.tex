  ...
  \cventry
    ...
    {Feb. 2026 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Drove overall CI/CD improvements: cut Docker image build time by 50\% and image size by up to 30\%, and removed custom \texttt{gcloud} installs to speed pipelines.}
        \item {Created tooling that lets colleagues self-serve tedious but simple tasks, such as managing subsidy-program records, provisioning user accounts, and triggering routine operations (e.g., sending emails).}
