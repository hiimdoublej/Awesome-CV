  ...
  \cventry
    ...
    {Feb. 2026 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Built tooling that lets colleagues self-serve tedious but simple tasks, including funding management, user provisioning, and operational triggers (e.g., manual email sends).}
