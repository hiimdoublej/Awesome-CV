  ...
  \cventry
    ...
    {Feb. 2026 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Plan, design and implement features for FastAPI applications.}
        \item {Leveraged best practices to reduce Docker image build time by 50\% and image size by up to 30\%.}
        \item {Implemented proper response streaming for an ADK (Agent Development Kit) application to enhance user experience.}
        \item {Automated daily chores with AI-assisted issue triage.}
      \end{cvitems}
    }
